...
export default function TopUp() {
  ...
  const exceedsBalance = amount > ACCOUNTS.investment.balance;
      ...
      <div>
        ...
        <div className="px-6 pt-14 flex flex-col items-center text-center">
          ...
          <p className="text-muted-foreground text-sm mt-2">
            {formatUSD(amount)} moved to your Current Account.
          </p>
        </div>
      </div>);
          ...
          <div className="relative flex gap-5">
            ...
            <div className="flex-1 flex flex-col">
              ...
              <div className="pb-5">
                ...
                <p className="text-sm text-muted-foreground mt-1">Available: {formatUSD(ACCOUNTS.investment.balance)}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-1">Balance: {formatUSD(ACCOUNTS.current.balance)}</p>
              </div>
            </div>
          </div>
        </div>
