...
export const STATIC_ASSETS = [
  ...
  },
  {
    ...
    color: '#F3BA2F',
    icon_letter: 'B',
    sparkline: [605, 608, 603, 611, 610, 614, 612.3],
  },
  {
    id: 'usdc',
    symbol: 'USDC',
...
export const STATIC_TRANSACTIONS = [
  ...
  { id: 'tx7', type: 'swap', symbol: 'BNB', amount: 2, usd_value: 1224.60, counterparty: 'Swap: BNB → ETH', status: 'confirmed', created_date: d(10, 13, 10) },
];